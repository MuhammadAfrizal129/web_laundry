...
<div class="container">
    ...
    <h3><center>Data Member</center></h3><br>
        <a href="{{url('kasir/datamember/create')}}" class="btn btn-success">Tambah Member</a>
        <br>
                    ...
                    @foreach ($member as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ url('kasir/datamember/' . $item->id_member )}}" class="btn btn-primary">Edit</a>
                                
                                
                                <a href="{{ url('kasir/datamember/' . $item->id_member .'/delete')}}" class="btn btn-danger">Delete</a>
