...
<div class="container">
    <div class="card p-5">
        ...
        <a href="{{url('admin/datatransaksi/create')}}" class="btn btn-success">Entry Transaksi</a>
        <br>
                    ...
                    @foreach ($transaksi as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ url('admin/datatransaksi/naikkan_status/'.$item->id_transaksi) }}" class="btn btn-primary">Pesanan</a>
                                
                                
                                <a href="{{ url('admin/datatransaksi/naikkan_status_pembayaran/'.$item->id_transaksi) }}" class="btn btn-info">Bayar</a>
        ...
        <br>
        <div align="center">
            <a href="{{ url('/admin/datastatuspesan')}}" class="btn btn-secondary">Atur Status Pesanan</a>
            <a href="{{ url('/admin/datastatusbayar')}}" class="btn btn-warning">Atur Status Pembayaran</a>
        </div>
    </div>
</div>
@endsection
