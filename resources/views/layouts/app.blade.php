            ...
            <div class="b-p app-header__content">
                ...
                <div class="app-header-center">
                    ...
                    <ul class="header-menu nav b-p">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/datatransaksi')}}" class="nav-link">
                            <i class="nav-link-icon fa fa-edit"></i>
                                Transaksi
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/datapaket')}}" class="nav-link">
                                <i class="nav-link-icon fa fa-edit"></i>
                                Paket
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/dataoutlet')}}" class="nav-link">
                                <i class="nav-link-icon fa fa-home"></i>
                                Outlet
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/datamember')}}" class="nav-link">
                                <i class="nav-link-icon fa fa-home"></i>
                                Pelanggan
                            </a>
                        </li>
